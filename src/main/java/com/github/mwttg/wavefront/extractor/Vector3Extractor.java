...
final class Vector3Extractor {
    ...
    /**
     * Takes the parts of a vertex/normal definition .obj file line (e.g. 'v 1.0 2.0 3.0' split at spaces)
     * and generates a {@link Vector3f} from it.
     *
     * @param parts of a .obj vertex/normal definition file line, containing the token and three numbers (u, y, and z)
