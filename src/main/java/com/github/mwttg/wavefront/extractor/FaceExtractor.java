...
final class FaceExtractor {
    ...
    /**
     * Takes the parts of a face definition .obj file line (e.g. 'f 1/3/7 2/5/8 3/6/9' split at spaces) and generates a
     * {@link Triangle} definition from it that hold the index information.
     *
